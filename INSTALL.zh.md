...
> 已在 DeepSeek Harness **0.1.7-rc.1** 上随 `dsh-tinyfish-search` **0.11.1** 完成全面验证。
...
- DeepSeek Harness `dsh` CLI `0.1.7-alpha.2` 或更新（任意带 web 缝的 profile，如 `web`）——已在 `0.1.7-rc.1` 上验证
