...
> Verified against DeepSeek Harness **0.1.6-alpha.1** with `dsh-tinyfish-search` **0.9.0**. All wire outputs below were captured from the shipped `lib/` build.
...
user-agent: dsh-tinyfish-search/0.9.0
