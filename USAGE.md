...
> Verified against DeepSeek Harness **0.1.5-rc.2** with `dsh-tinyfish-search` **0.6.1**. All wire outputs below were captured from the shipped `lib/` build.
...
user-agent: dsh-tinyfish-search/0.6.1
